  ...
  return (
    ...
    >
      ...
      <Typography
        ...
        style={
          !darkModeStatus
            ? { color: "#000000", marginTop: "150px", marginBottom: "15px" }
            : { color: "#ffffff", marginTop: "150px", marginBottom: "15px" }
        }
      >
        {currentLanguageSelected === "English"
          ? LocaleEnglish.thankYou.thankYouLine1
          : LocaleGerman.thankYou.thankYouLine1}
      </Typography>
      <Typography
        variant="subtitle1"
        style={!darkModeStatus ? { color: "#000000" } : { color: "#ffffff" }}
      >
        {currentLanguageSelected === "English"
          ? LocaleEnglish.thankYou.thankYouLine2
          : LocaleGerman.thankYou.thankYouLine2}
      </Typography>
    </div>
  );
};
